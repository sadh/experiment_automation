...
#ssh -i ../.ssh/id_rsa client@192.168.0.101 tshark -r test_automation.cap -T fields -e frame.number -e frame.time_relative -e frame.time_delta -e frame.time_delta_displayed -e frame.time_relative > test_automation.csv
